CREATE OR REPLACE PROCEDURE Artist_View (artistLastName IN char)
AS
    ...
    CURSOR artistcursor IS 
        SELECT LastName, FirstName, Nationality, DateofBirth, DateDeceased
        FROM ARTIST
...
FOR artist IN artistcursor 
    ...
    DBMS_OUTPUT.PUT_LINE ('Artist Name = '||RTRIM(readLastName)||', 
    '||RTRIM(readFirstName)||' 
